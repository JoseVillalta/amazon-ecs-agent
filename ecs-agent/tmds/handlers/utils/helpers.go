...
const (
	...
	// RequestTypeTasksMetadata specifies the task metadata request type of TaskContainerMetadataHandler.
	...
	// RequestTypeTasksStats specifies the task stats request type of StatsHandler.
